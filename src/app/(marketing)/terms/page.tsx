        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="space-y-10 text-slate-600 text-sm leading-relaxed">
            ...
            <div>
              ...
              <p className="mb-3">
                DutyProof offers multiple subscription tiers: Contractor ($199/month — up to 10 watches per month, unlimited job sites), Professional ($499/month — unlimited watches and job sites), and Enterprise (custom pricing). There are no per-user fees or setup costs. Your first watch is free with all features.
              </p>
              <p className="mb-3">
