...
export default function MarketingLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-blue-700 text-white text-xs font-semibold py-2.5 px-4 text-center flex items-center justify-center gap-2 flex-wrap">
        <span className="hidden sm:inline opacity-80">CMS surveys happen year-round ·</span>
        <Link
          href="/signup"
          className="underline underline-offset-2 hover:text-blue-200 transition-colors whitespace-nowrap"
        >
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center">
            <BrandLogo className="w-[340px] h-auto" variant="dark" />
          </Link>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-6">
            <div className="flex items-center gap-3">
              <BrandLogo className="w-[200px] h-auto" variant="light" />
